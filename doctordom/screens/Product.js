;(function(){
  function render(productId){
    ...
    // skeleton first
    screen.innerHTML = `
      <div class="skeleton-line" style="width:60%;margin:6px 0"></div>
      <div class="skeleton" style="height:200px;border-radius:16px"></div>
      <div class="skeleton-line" style="width:40%;margin:10px 0 6px"></div>
      ...
      <div class="product-detail fade-in">
        ...
        <div>
          ...
          <div class="sticky-cta">
            <div class="price"><span class="current-price">${p.price.toLocaleString()} ₽</span></div>
            <div class="action-buttons">
              <button class="btn-add-large" data-product-id="${p.id}">В корзину</button>
