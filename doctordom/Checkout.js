    ...
    render() {
        ...
        checkoutScreen.innerHTML = `
            ...
            <div class="cart-total glass-card fade-in" style="margin-top:12px; padding:16px; border:1px solid var(--line); border-radius:12px;">
                <div class="summary-row"><span>Товары</span><span>${cartTotal.toLocaleString()} ₽</span></div>
                <div class="summary-row"><span>Доставка</span><span id="delivery-cost">0 ₽</span></div>
                <div class="summary-row total"><span>Итого</span><span id="final-total">${cartTotal.toLocaleString()} ₽</span></div>
            </div>
        ...
        document.querySelectorAll('input[name="delivery"]').forEach(radio => {
            radio.addEventListener('change', () => {
                ...
                deliveryCost.textContent = method.price.toLocaleString() + ' ₽';
                finalTotal.textContent = (cartTotal + method.price).toLocaleString() + ' ₽';
            });
        });
    }
